      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <?php 
            if (isset($_SESSION['username'])) { ?>
              <li class="dropdown">
            <?php echo '<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">' . $_SESSION['username'] . '<span class="caret"></span></a>'; ?>
            <ul class="dropdown-menu">
              <li><a href="Profile.php">الملف الشخصي</a></li>
              <?php 
                if (isset($_SESSION['User-Group']) && $_SESSION['User-Group'] == 3) {
                  echo '<li><a href="Admin/Admin.php">لوحة التحكم</a></li>';
                }
              ?>  
